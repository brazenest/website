...
export const productionProjects: ProductionProject[] = [
  {
    ...
    description:
      "A golf video production project developed through Radiant, my broader media venture. The work treats production as a repeatable system: capture technique clearly, preserve the rhythm of play, and build footage that can support multiple useful edits.",
    cardContext:
      "Golf production · Radiant media venture · Capture and editorial system",
    cardDemonstrates:
      "Subject-specific production planning for golf. Repeatable coverage choices that make motion and context legible. Editorial standards designed for a larger media property, not just one finished clip.",
  },
  {
    ...
    cardContext:
      "Observational short · Director/Shooter/Editor · Live night exterior",
    cardDemonstrates:
  ...
  },
  {
    ...
    cardContext:
      "Launch narrative · End-to-end production · Interview direction and edit",
    cardDemonstrates:
  ...
  },
  {
    ...
    cardContext:
      "Social campaign system · Creative development/production/edit",
    cardDemonstrates:
