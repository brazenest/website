...
export const engineeringHeroContent: EngineeringHeroContent = {
  ...
  description:
    'This side starts with selected projects, then moves into the principles behind them: system design, implementation tradeoffs, and long-term maintainability as products evolve.',
