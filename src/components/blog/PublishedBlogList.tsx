                    ...
                    <div class="flex flex-col gap-5">
                      {post.coverImageUrl && (
                        <img
                          ...
                          class="aspect-[2/1] w-full rounded-[var(--radius-lg)] border border-[var(--border)] object-cover"
                          width={672}
                          height={336}
                        />
                      )}
                      ...
                      <div class="flex flex-col gap-3">
                        <h3 class="text-xl font-semibold leading-snug tracking-tight transition-colors duration-[var(--motion-duration-quick)] ease-[var(--motion-easing-quick)] group-hover:text-[var(--state-hover-accent)] md:text-2xl">
                          {post.title}
                        </h3>
                        ...
                        <div class="pt-1">
                          <LinkText label={`Read: ${post.title}`} class="w-fit" />
                        </div>
                      </div>
                    </div>
                  </article>
